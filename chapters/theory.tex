...
weak isospin \cite{Thomson:2013zua}, as explained later in this chapter.
...
generations. In the Standard Mode, there
...
gravitational interactions \cite{Zwicky2008, rotation, Ade:2015, Clowe:2006}, and the
existence of dark energy from the Type 1a supernovae brightness-redshift relationship
\cite{Knop:2003iy} and via the measurements of
the cosmic microwave background spectrum \cite{Ade:2015}. Neither dark matter nor
