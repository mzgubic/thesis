...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \caption{$\tth$}
  \end{subfigure}
  \caption[Main Higgs boson production modes at the LHC.]{Main Higgs boson production modes at the LHC.
...
For the SM Higgs boson with $m_H = 125~\GeV$, the predicted decay rate to muon pairs
is $2.176 \times 10^{-4}$ with the theoretical uncertainty of 1.23\%, and parametric
uncertainties from quark masses and strong coupling constant of 0.99\% and 0.64\%,
respectively \cite{deFlorian:2016spz}.
...
\begin{figure}[h]
  ...
  \caption[Higgs boson decays.]{Higgs boson decays. From Ref. \cite{deFlorian:2016spz}.}
   \label{fig:the:decay}
\end{figure}
