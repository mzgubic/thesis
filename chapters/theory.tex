...
$SU(3)_C \times SU(2)_L \times U(1)_Y$ local gauge redundancy.
...
the $SU(2)_L \times U(1)_Y$ group symmetry. Here, the $L$ refers to left-handed
...
are invariant under $SU(2)_L \times U(1)_Y$ transformations. They give rise to both the fermion mass terms
