...
\begin{itemize}
\item The electromagnetic calorimeter (ECAL) is used for precision
...
The muon spectrometer is the outermost part of the ATLAS detector and was designed to
...
The monitored drift tube (MDT) chambers provide precision tracking up to
...
The cathode strip chambers (CSC) are multiwire proportional chambers
...
The resistive plate chambers (RPC) are gaseous detectors used for
