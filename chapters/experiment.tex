...
and consists of three layers of silicon pixel detectors with a total
of approximately 80 million channels. Before LHC Run 2 a new layer,
called insertable B-layer (IBL), was added in order to provide
robustness against inefficiencies in the pixels caused by radiation
damage and improve resolution. The resolution in the bending plane,
relevant for the measurement of $\pt$, is about 10$\mu m$
\cite{CERN-LHCC-97-016, Capeans:1291633}. 
...
\begin{figure}[h]
  ...
  \caption[The ATLAS tracker.]{The ATLAS tracker. 
