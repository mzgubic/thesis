...
barrel region, and three disks in the endcap regions with a total of
...
and to enable good position resolution. Before LHC Run 2 a new layer,
...
inefficiencies in the pixels caused by radiation damage and improve
resolution. The strip pitch in the bending plane, relevant for the
...
precision in the bending plane, while the reduction in the number of
...
tracker system. Unlike the silicon counterparts it does not come in layers
