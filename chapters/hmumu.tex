...
and the Sideband region are defined by requirements on the invariant
mass, summarised in Table \ref{tab:hmumu:regions}.
...
\midrule
Signal region          & $110 < \mmumu < 160$ \GeV \\
\midrule
...
\begin{figure}[h!]
  ...
  The invariant mass spectrum is shown after the correction for
  final state radiation, for data corresponding to 139 $\ifb$ and
  appropriately normalised MC simulation. Data is shown as black
