...
\begin{figure}[h!]
  ...
  error bars on data. Reproduced from Ref. \cite{ATLAS-CONF-2019-028}}
...
\begin{figure}[h!]
  ...
  are shown in blue, and top events in dark blue. Reproduced from Ref.
...
\end{equation}
The so-called CL$_s$ upper limits are obtained by solving for $\mu$ which
