...
For this reason detailed kinematics of the individual muons
are not included.
...
%Low    & $O^0_{\ggf} < 0.35$            & $O^1_{\ggf} < 0.38$            & $O^2_{\ggf} < 0.22$             & $O_\text{VBF} < 0.77$ \\
                              ...
                              &    High                   &  Medium                          & Low \\ 
0-jet                         & $O^0_{\ggf} \geq 0.75$    &  $0.35 \leq O^0_{\ggf} < 0.75$   & $O^0_{\ggf} < 0.35$   \\
1-jet                         & $O^1_{\ggf} \geq 0.78$    &  $0.38 \leq O^1_{\ggf} < 0.78$   & $O^1_{\ggf} < 0.38$   \\
2-jet($O_\text{VBF} < 0.60$)  & $O^2_{\ggf} \geq 0.48$    &  $0.22 \leq O^2_{\ggf} < 0.48$   & $O^2_{\ggf} < 0.22$   \\
VBF                           & $O_\text{VBF} \geq 0.89$  &  $0.77 \leq O_\text{VBF} < 0.89$ & $O_\text{VBF} < 0.77$ \\
...
$c$. Since the optimisation is performed blinded $b_c$ is computed
from the number of data events in the sideband region, multiplied
...
- BDT output data/mc
- resolution in each of the categories data/mc
