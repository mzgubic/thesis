...
$\met$ is used in the analysis to discriminate between the signal and
$\ttbar$ processes, and is used as an input to the multivariate
discriminant in the 2-jet channel.
