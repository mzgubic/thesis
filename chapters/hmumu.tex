...
state radiation, and by the better rejection of \pileup~ jets in the
...
setup an additional cut of $\mmumu > 100$ \GeV. Finally, 
...
the detector. Muon momentum smearing is done using a parametrised functions
...
from data. FSR momentum is smeared using a parametrised prescription
...
\begin{figure}[h!]
  ...
  green line. Inclusive distribution is shown as a solid orange
  line.}
...
contains approximately 250,000 events in data, of which about
...
\begin{figure}[h!]
  ...
  Error bars are statistical. Reproduced from Ref. \cite{ATLAS-CONF-2019-028}.
  }
...
\begin{figure}[h!]
  ...
  MC simulation. The blue band represents experimental systematic
...
on the $\pt$ of the Higgs boson, uncertainties on the migrations between
