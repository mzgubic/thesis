...
In addition to the systematic uncertainty on the background modelling,
the spurious signal uncertainty described in the previous section,
there are systematic uncertainties which affect the signal normalisation
and its distribution between the categories. The systematic uncertaintes
come from both the theoretical and experimental uncertainties, both of
which can affect the normalisation and the migration between the categories.

It should be noted, however, that at present the analysis is limited by
...
in the fit region of the custom DY sample. Prior to the fit,
