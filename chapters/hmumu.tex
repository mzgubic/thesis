...
split based on number of jets

training set (signal, background, cuts, etc)
2-jet case: VBF and higgs classifiers
four fold method, hyperparameter optimisation in which hps
ordering: quantile transform, add together
variables used: maximise sensitivity, minimise systematics, no bias found
BDT boundaries optimisation: number counting significance is the metric
