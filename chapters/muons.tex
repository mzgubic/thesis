...
There were two main motivations for the study in the context of
improving the sensitivity of the $\hmumu$ analysis:
\begin{itemize}
\item Estimate the muon $\pt$ resolution for each individual muon
based on its kinematics and reconstruction quality metrics. Propagate
the estimated resolution of individual muons to estimate the resolution
of the invariant mass measurement of the muon pair. Finally, use this
estimate to split events in resolution categories and hence improve the
sensitivity of the analysis. This could be done directly on the CB muons.
\item Somewhat more speculatively, could the muon reconstruction
...
\end{itemize}
Two datasets were prepared to facilitate the study. The "single muon"
