...
\begin{figure}[h!]
  ...
  \caption[Muon momentum calibration validation]{Muon momentum calibration
...
Tag-and-probe method selects events with a pair of muons with invariant mass
...
processes, inclusing both the $Z\rightarrow\mu\mu$ decays as well events with fake
...
\begin{figure}[h!]
  ...
  Error bars represent statistical uncertainties while the systematic uncertainty arising from
...
\begin{figure}[h!]
  ...
  in data collected in 2017 for events with number of interaction vertices smaller
