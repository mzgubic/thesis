...
\toprule
Region   & Charge & $\pt$ range & Tag muon $|d_0/\sigma_{d_0}|$ & Probe muon $|d_0/\sigma_{d_0}|$ \\
\midrule
Region B & SC & 3-25 \GeV & $|d_0/\sigma_{d_0}|_\text{tag} < 3.0$ & $|d_0/\sigma_{d_0}|_\text{probe} < 3.0$ \\
\midrule
\multirow{2}{*}{Region C} & OC & 3-25 \GeV  & $|d_0/\sigma_{d_0}|_\text{tag} > 3.0$ & $|d_0/\sigma_{d_0}|_\text{probe} > 3.0$ \\
& OC & 3-25 \GeV  & $|d_0/\sigma_{d_0}|_\text{tag} > 3.0$ & $|d_0/\sigma_{d_0}|_\text{probe} > 3.0$ \\
\midrule
Region D & SC & 3-25 \GeV & $|d_0/\sigma_{d_0}|_\text{tag} > 3.0$ & $|d_0/\sigma_{d_0}|_\text{probe} > 3.0$ \\
\bottomrule
\end{tabular}
\end{table}
...
validation study with pseudodata.

talk about the range in which the method is applicable

possible improvements of the method.

LooseTrackOnly, PflowFixedCutLoose
