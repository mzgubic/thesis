...
to estimate $\alpha$, the 84$^\text{th}$ (68\% + one tail) quantile of the
distribution in Eq. \ref{eq:muon:pull} is estimated. A quantile loss
function, a generalisation of the least absolute deviation, is used
\cite{qreg}. The input variables are restricted to $\pt^\text{CB}$, $\eta$
