...
background events in data is the same in the same charge (SC) as in
the opposite charge (OC) phase space:
\begin{equation}
\epsilon_{\zmumu} =
...
comes from the background subtraction, as the assumption $T=1$ is
challenged. Additional systematic uncertainties on the scale factor
...
\begin{table}[h]
\centering
\caption{Systematic uncertainties associated with the measurement
of the isolation selection scale factors.}
