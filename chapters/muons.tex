...
$|\eta| < 2.5$, the longitudinal impact parameter smaller than $3~\mm$, and satisfy a
...
subtracted for the efficiency measurement in the data. The old method of
...
tracks in a non-obvious way, and that no improvement is achievable
